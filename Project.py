...
st.set_page_config(
    page_title="Multi-Document Summarization using llama2",
    page_icon="🦙",
    layout="wide"
)
...
st.title("Text Summarization and Q&A with llama2 🦙")
...
def main():
    ...
    st.title("Multi-Docs QnA ChatBot")
    # Initialize Streamlit
    st.sidebar.title("Q&A bot Documnet Uploader ⬇️")
